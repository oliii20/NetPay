...
var batchHeaders = []string{
	...
	"SplitAllocationCount", "MatchedIntentRatio", "FullMatchedIntentRatio", "MatchedValueRatio", "FallbackIntentRatio",
...
func (c *Collector) batchRows() [][]string {
	...
	for _, record := range records {
		...
		rows = append(rows, []string{
			...
			ratioInt(batch.FullMatchedIntentCount, batch.IntentCount), ratioBig(batch.MatchedValue, batch.OriginalValue),
			ratioInt(batch.FallbackIntentCount, batch.IntentCount),
