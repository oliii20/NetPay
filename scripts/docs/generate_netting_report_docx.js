...
function docChildren() {
  ...
  children.push(para("实验运行脚本为 scripts/netting_experiments/run_experiments.py，画图脚本为 scripts/netting_experiments/plot_experiments.py。plot 脚本输出 figures/netting/*.png，采用论文风格布局、色盲友好配色和简洁网格。"));
