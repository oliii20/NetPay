...
def summarize_netting(run_dir: Path, spec: RunSpec, elapsed_s: float) -> dict[str, object]:
    ...
    return {
        ...
        "full_matched_intent_ratio": weighted_ratio(batches, "FullMatchedIntentRatio", "IntentCount"),
...
SUMMARY_FIELDS = [
    ...
    "full_matched_intent_ratio", "fallback_intent_ratio", "split_allocations", "match_time_ms", "proof_time_ms",
